        ...
        implements DatePickerDialog.OnDateSetListener
{
    ...
    public void onDateSet(final android.widget.DatePicker view, int year, int monthOfYear, int dayOfMonth)
    {
        ...
        int correctMonthIndex = view.getMonth() + 1;
        dobButton.setText(view.getDayOfMonth() + "." + correctMonthIndex + "."+view.getYear());
        // Passes the date to the database
        UserImplementation.getUserObject().setDateOfBirth(view.getDayOfMonth() + "." + correctMonthIndex + "." + view.getYear());
